...
// Requires Google Cloud project + Google Ads API access

export class GoogleAdsIntegration implements IntegrationPlugin {
  ...
  async getCampaigns(): Promise<PlatformCampaign[]> {
    // TODO: Implement Google Ads API campaign list
    return []
  }

  async getAnalytics(_dateRange: DateRange): Promise<PlatformAnalytics> {
    // TODO: Implement Google Ads reporting API
