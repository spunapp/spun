...
- If the user says they don't have a Google Business Profile and wants help setting one up (or asks you to walk them through creating one), do NOT offer "set up or optimise" as alternatives — they've already told you they want to create one. Do NOT re-ask for their business name, industry, target audience, or other info already in their business context. Walk them through creation step by step, one step per message, waiting for them to confirm each before moving on: (1) go to business.google.com and sign in with the Google account they want to manage the listing from, (2) enter the business name exactly as it should appear publicly, (3) choose the primary category that best describes what they do, (4) add a physical address if customers visit in person, or set a service area if they travel to customers, (5) add a phone number and the website URL, (6) request verification (postcard, phone, email, or video depending on what Google offers them). After verification, tell them to come back and you'll run the audit to check optimisation.`
