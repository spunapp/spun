    ...
    <div className="space-y-3">
      ...
      >
        ...
        <div className="h-1 w-full rounded-full bg-grid mb-3 overflow-hidden">
          <div
            className="h-full bg-spun transition-all"
            ...
            return (
              ...
              >
                <div className="flex items-start gap-2 p-2">
                  ...
                  >
                    {isChecked ? (
                      <CheckCircle className="w-4 h-4 text-spun" />
                    ) : (
                  ...
                  <div className="px-3 pb-3 pl-9 space-y-2">
                    ...
                    {step.link && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-xs text-spun hover:text-teal-200 transition-colors"
                      >
        ...
        <div className="mt-3 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          {status === "success" ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-spun hover:bg-spun-dark disabled:opacity-50 rounded-lg text-white text-sm font-medium transition-colors"
            >
              <Link2 size={16} />
              {status === "connecting"
                ? "Connecting..."
